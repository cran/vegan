...
... procrustes: rmse 9.501138e-05  max resid 0.0002893396 
*** Solution reached
\end{Soutput}
\begin{Sinput}
> ord
...
***VECTORS
     ...
     NMDS1   NMDS2     r2 Pr(>r)  
A1 0.99008 0.14052 0.3798  0.022 *
---
...
Model: cca(formula = dune ~ A1 + Management + Condition(Moisture), data = dune.env)
           Df ChiSquare      F Pr(>F)   
A1          1   0.11543 1.4190  0.114   
Management  3   0.39543 1.6205  0.008 **
Residual   12   0.97610                 
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
\end{Soutput}
