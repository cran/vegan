...
BCI data, but here our random plot (number 19):
\begin{Schunk}
\begin{Sinput}
> prestondistr(BCI[k,])
\end{Sinput}
...
No. of species: 109 
      ...
      mode      width         S0 
 0.7413741  1.6466177 30.8918794 

Frequencies by Octave
                0        1        2        3        4
Observed 24.00000 31.50000 27.00000 15.50000 7.000000
Fitted   27.91419 30.51318 23.06606 12.05821 4.359291
                5        6
Observed 2.000000 2.000000
Fitted   1.089864 0.188431
\end{Soutput}
\end{Schunk}
...
No. of species 109, total abundance 433

           par1      par2     par3    Deviance AIC    
Null                                  107.226  407.427
Preemption  0.039379                  116.077  418.279
Lognormal   0.71068   1.1749           33.423  337.625
Zipf        0.13801  -0.85783          17.544  321.746
Mandelbrot  0.2784   -1.0446   1.4238  10.475  316.677
           BIC    
Null       407.427
Preemption 420.970
Lognormal  343.007
...
\caption{Ranked abundance distribution models for a random plot
  (no. 19).  The best model has the lowest \textsc{aic}.}
\label{fig:rad}
\end{figure}
...
\begin{Soutput}
    Species     chao  chao.se  jack1 jack1.se    jack2
All     205 221.2635 8.712418 228.04 8.022369 235.1317
        boot  boot.se  n
All 216.3726 4.381816 25
\end{Soutput}
\end{Schunk}
