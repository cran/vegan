...
\end{Schunk}
\begin{SCfigure}
\includegraphics{decision-vegan-003}
...
cca(formula = varespec[i, ] ~ Al + K, data = varechem) 
              ...
              Inertia Rank
Total          2.0832     
Constrained    0.2049    2
Unconstrained  1.8783   21
Inertia is mean squared contingency coefficient 
...
Eigenvalues for unconstrained axes:
    CA1     CA2     CA3     CA4     CA5     CA6     CA7     CA8 
0.51766 0.33456 0.19585 0.18559 0.16415 0.11306 0.08704 0.07195 
(Showed only 8 of all 21 unconstrained eigenvalues)
\end{Soutput}
\end{Schunk}
...
observed 2.1726e-14 because site
...
\begin{SCfigure}
\includegraphics{decision-vegan-014}
