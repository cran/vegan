...
Constrained   0.12013    0.05767    2
Unconstrained 1.96307    0.94233   21
Inertia is mean squared contingency coefficient 
...
Eigenvalues for unconstrained axes:
    CA1     CA2     CA3     CA4     CA5     CA6     CA7     CA8 
0.51918 0.34182 0.22753 0.18414 0.16480 0.11412 0.08290 0.07883 
(Showed only 8 of all 21 unconstrained eigenvalues)
\end{Soutput}
\end{Schunk}
...
R> proc <- procrustes(scores(tmp1, dis = "lc", choi = 1:14), scores(tmp2, 
+      dis = "lc", choi = 1:14))
...
observed 3.1798e-14 because site
