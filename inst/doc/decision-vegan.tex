...
\date{$ $Id: decision-vegan.Rnw 1405 2010-12-09 14:08:15Z jarioksa $ $
...
Call: cca(formula = varespec[i, ] ~ Al + K, data = varechem)
              ...
              Inertia Proportion Rank
Total          2.0832     1.0000     
Constrained    0.2454     0.1178    2
Unconstrained  1.8378     0.8822   21
Inertia is mean squared contingency coefficient 
...
Eigenvalues for unconstrained axes:
    CA1     CA2     CA3     CA4     CA5     CA6     CA7     CA8 
0.45629 0.31633 0.21490 0.18291 0.14970 0.10447 0.09545 0.08445 
(Showed only 8 of all 21 unconstrained eigenvalues)
\end{Soutput}
\end{Schunk}
...
observed 2.2243e-14 because site
