...
\date{$ $Id: decision-vegan.Rnw 1088 2010-01-02 14:01:15Z jarioksa $ $
...
Call: cca(formula = varespec[i, ] ~ Al + K, data = varechem)
              ...
              Inertia Rank
Total          2.0832     
Constrained    0.1154    2
Unconstrained  1.9678   21
Inertia is mean squared contingency coefficient 
...
Eigenvalues for unconstrained axes:
    CA1     CA2     CA3     CA4     CA5     CA6     CA7     CA8 
0.50287 0.34580 0.22692 0.17691 0.17408 0.11886 0.10789 0.08442 
(Showed only 8 of all 21 unconstrained eigenvalues)
\end{Soutput}
\end{Schunk}
...
observed 2.7591e-14 because site
