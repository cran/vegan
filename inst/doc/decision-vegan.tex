...
\date{$ $Id: decision-vegan.Rnw 254 2008-03-06 20:32:48Z jarioksa $ $
...
cca(formula = varespec[i, ] ~ Al + K, data = varechem) 
              ...
              Inertia Rank
Total          2.0832     
Constrained    0.1811    2
Unconstrained  1.9021   21
Inertia is mean squared contingency coefficient 
...
Eigenvalues for unconstrained axes:
    CA1     CA2     CA3     CA4     CA5     CA6     CA7     CA8 
0.50479 0.35466 0.20192 0.17783 0.14818 0.11325 0.08613 0.07492 
(Showed only 8 of all 21 unconstrained eigenvalues)
\end{Soutput}
\end{Schunk}
...
observed 2.7641e-14 because site
