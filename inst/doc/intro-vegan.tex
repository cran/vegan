...
... New best solution
... procrustes: rmse 0.003136614  max resid 0.01076355 
Run 2 stress 11.97273 
... New best solution
... procrustes: rmse 0.0199497  max resid 0.06280981 
Run 3 stress 18.97843 
Run 4 stress 11.97273 
... New best solution
... procrustes: rmse 3.738626e-05  max resid 7.506921e-05 
*** Solution reached
\end{Soutput}
\begin{Sinput}
> ord
...
***VECTORS
     ...
     NMDS1   NMDS2     r2  Pr(>r)  
A1 0.97951 0.20141 0.3689 0.02498 *
---
...
Model: cca(formula = dune ~ A1 + Management, data = dune.env)
           Df  Chisq      F N.Perm  Pr(>F)   
A1          1 0.1759 1.9761    299 0.01667 * 
...
CCA4      1 0.0917 1.0297     99 0.41000   
Residual 15 1.3355                         
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
\end{Soutput}
