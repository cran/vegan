...
... New best solution
... procrustes: rmse 0.003137486  max resid 0.01078891 
Run 2 stress 11.97274 
... New best solution
... procrustes: rmse 0.01999184  max resid 0.06287138 
Run 3 stress 11.97293 
... procrustes: rmse 0.0005003883  max resid 0.001324002 
*** Solution reached
\end{Soutput}
\begin{Sinput}
> ord
...
***VECTORS
      ...
      NMDS1    NMDS2     r2  Pr(>r)  
A1 -0.97940 -0.20194 0.3689 0.02498 *
---
...
ManagementHF  0.2713  0.1209
ManagementNM -0.3267 -0.5688
ManagementSF -0.1259  0.4685

Goodness of fit:
               r2   Pr(>r)   
Management 0.4206 0.005994 **
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
P values based on 1000 permutations.
\end{Soutput}
...
CCA2      1 0.2372 2.6640    499 0.02800 *
CCA3      1 0.1322 1.4845     99 0.22000  
