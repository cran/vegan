...
Run 1 stress 11.97273 
... New best solution
... procrustes: rmse 0.01950976  max resid 0.06038378 
Run 2 stress 11.97273 
... procrustes: rmse 3.344300e-05  max resid 7.426618e-05 
*** Solution reached
\end{Soutput}
\begin{Sinput}
> ord
...
***VECTORS
     ...
     NMDS1   NMDS2     r2 Pr(>r)  
A1 0.97950 0.20144 0.3689   0.02 *
---
...
Model: cca(formula = dune ~ A1 + Management, data = dune.env)
           Df  Chisq      F N.Perm  Pr(>F)   
A1          1 0.1759 1.9761    899 0.03111 * 
...
CCA2      1 0.2372 2.6640    599 0.05000 *
CCA3      1 0.1322 1.4845     99 0.31000  
