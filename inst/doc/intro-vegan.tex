...
Run 1 stress 12.04547 
... New best solution
... procrustes: rmse 0.003121936  max resid 0.01079269 
Run 2 stress 12.04546 
... New best solution
... procrustes: rmse 0.0001429895  max resid 0.0004220932 
*** Solution reached
\end{Soutput}
\begin{Sinput}
> ord
...
***VECTORS
       ...
       NMDS1     NMDS2     r2 Pr(>r)  
A1 -0.997178 -0.075077 0.3863  0.015 *
---
...
Centroids:
               NMDS1   NMDS2
ManagementBF  0.4505  0.0052
ManagementHF  0.2740  0.1184
ManagementNM -0.3308 -0.5692
ManagementSF -0.1228  0.4679

Goodness of fit:
              r2 Pr(>r)   
Management 0.422  0.008 **
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
P values based on 1000 permutations.
\end{Soutput}
...
Model     4 0.7798 2.1896    199   0.01 **
Residual 15 1.3355                        
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
\end{Soutput}
...
Model: cca(formula = dune ~ A1 + Management, data = dune.env)
           Df  Chisq      F N.Perm Pr(>F)   
A1          1 0.1759 1.9761    399 0.0225 * 
Management  3 0.5550 2.0780    199 0.0050 **
Residual   15 1.3355                        
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
\end{Soutput}
...
CCA2      1 0.2372 2.6640    499  0.050 * 
CCA3      1 0.1322 1.4845     99  0.320   
CCA4      1 0.0917 1.0297     99  0.330   
Residual 15 1.3355                        
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
\end{Soutput}
