...
... New best solution
... procrustes: rmse 0.003143370  max resid 0.01080942 
Run 2 stress 12.04546 
... procrustes: rmse 5.53678e-05  max resid 0.0001551746 
*** Solution reached
\end{Soutput}
\begin{Sinput}
> ord
...
***VECTORS
      ...
      NMDS1    NMDS2     r2 Pr(>r)  
A1 0.997172 0.075151 0.3863  0.014 *
---
...
ManagementNM  0.3307  0.5692
ManagementSF  0.1228 -0.4680

Goodness of fit:
               r2 Pr(>r)   
Management 0.4219  0.005 **
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
P values based on 1000 permutations.
\end{Soutput}
