...
... New best solution
... procrustes: rmse 0.003063957  max resid 0.01044394 
Run 2 stress 12.04547 
... New best solution
... procrustes: rmse 0.0001550631  max resid 0.0004288721 
*** Solution reached
\end{Soutput}
\begin{Sinput}
> ord
...
***VECTORS
      ...
      NMDS1    NMDS2     r2 Pr(>r)  
A1 0.997184 0.074994 0.3863  0.019 *
---
...
ManagementHF -0.2739 -0.1183
ManagementNM  0.3308  0.5691
ManagementSF  0.1227 -0.4680

Goodness of fit:
              r2 Pr(>r)   
Management 0.422  0.007 **
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
P values based on 1000 permutations.
\end{Soutput}
...
Model: cca(formula = dune ~ A1 + Management, data = dune.env)
         Df  Chisq      F N.Perm  Pr(>F)  
CCA1      1 0.3187 3.5801    199 0.01500 *
CCA2      1 0.2372 2.6640    599 0.04167 *
CCA3      1 0.1322 1.4845     99 0.27000  
CCA4      1 0.0917 1.0297     99 0.35000  
Residual 15 1.3355                        
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
\end{Soutput}
