...
\date{$ $Id: intro-vegan.Rnw 205 2008-02-15 06:08:56Z jarioksa $ $
...
... New best solution
... procrustes: rmse 0.003129778  max resid 0.01072834 
Run 2 stress 18.23000 
Run 3 stress 12.04547 
... procrustes: rmse 7.29894e-05  max resid 0.0001937243 
*** Solution reached
\end{Soutput}
\begin{Sinput}
> ord
...
***VECTORS
      ...
      NMDS1    NMDS2     r2 Pr(>r)  
A1 0.997182 0.075019 0.3863  0.021 *
---
...
Centroids:
               NMDS1   NMDS2
ManagementBF -0.4504 -0.0052
ManagementHF -0.2740 -0.1183
ManagementNM  0.3308  0.5692
ManagementSF  0.1227 -0.4679

Goodness of fit:
              r2 Pr(>r)   
Management 0.422  0.003 **
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
P values based on 1000 permutations.
\end{Soutput}
...
Model: cca(formula = dune ~ A1 + Management, data = dune.env)
           Df  Chisq      F N.Perm  Pr(>F)   
A1          1 0.1759 1.9761   1299 0.03385 * 
...
CCA2      1 0.2372 2.6640    499  0.048 * 
CCA3      1 0.1322 1.4845     99  0.290   
CCA4      1 0.0917 1.0297     99  0.460   
Residual 15 1.3355                        
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
\end{Soutput}
...
Management  3 0.3954 1.6205     99   0.06 .
Residual   12 0.9761                       
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
\end{Soutput}
