...
1.17-7
in R version 2.12.2 beta (2011-02-15 r54439) on \today}
\usepackage{Sweave}
\begin{document}
...
... New best solution
... procrustes: rmse 0.01950784  max resid 0.06037999 
Run 3 stress 12.04547 
Run 4 stress 20.10062 
Run 5 stress 12.04546 
Run 6 stress 12.04546 
Run 7 stress 11.97273 
... procrustes: rmse 2.184783e-05  max resid 4.327431e-05 
*** Solution reached
\end{Soutput}
\begin{Sinput}
> ord
...
***VECTORS
      ...
      NMDS1    NMDS2     r2  Pr(>r)  
A1 -0.97951 -0.20139 0.3689 0.01898 *
---
...
CCA3      1 0.1322 1.4845     99  0.140   
CCA4      1 0.0917 1.0297     99  0.400   
Residual 15 1.3355                        
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
\end{Soutput}
