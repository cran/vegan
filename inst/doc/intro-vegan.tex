...
... New best solution
... procrustes: rmse 0.01950954  max resid 0.06040506 
Run 2 stress 11.97273 
... New best solution
... procrustes: rmse 2.493715e-05  max resid 6.862633e-05 
*** Solution reached
\end{Soutput}
\begin{Sinput}
> ord
...
***VECTORS
     ...
     NMDS1   NMDS2     r2 Pr(>r)  
A1 0.97953 0.20131 0.3689  0.018 *
---
...
Model: cca(formula = dune ~ A1 + Management, data = dune.env)
           Df  Chisq      F N.Perm  Pr(>F)   
A1          1 0.1759 1.9761   1599 0.03562 * 
...
CCA2      1 0.2372 2.6640    499  0.036 *
CCA3      1 0.1322 1.4845     99  0.330  
