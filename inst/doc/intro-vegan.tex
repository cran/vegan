...
... New best solution
... procrustes: rmse 0.003143746  max resid 0.01081074 
Run 2 stress 12.04546 
... New best solution
... procrustes: rmse 7.398621e-05  max resid 0.000178559 
*** Solution reached
\end{Soutput}
\begin{Sinput}
> ord
...
***VECTORS
      ...
      NMDS1    NMDS2     r2  Pr(>r)  
A1 -0.99720 -0.07481 0.3863 0.01598 *
---
...
ManagementNM -0.3309 -0.5691
ManagementSF -0.1227  0.4679

Goodness of fit:
              r2   Pr(>r)   
Management 0.422 0.006993 **
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
P values based on 1000 permutations.
\end{Soutput}
...
Model: cca(formula = dune ~ A1 + Management, data = dune.env)
         Df  Chisq      F N.Perm Pr(>F)   
CCA1      1 0.3187 3.5801    199 0.0050 **
CCA2      1 0.2372 2.6640    199 0.0050 **
CCA3      1 0.1322 1.4845    399 0.0925 . 
CCA4      1 0.0917 1.0297     99 0.4300   
Residual 15 1.3355                        
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
\end{Soutput}
