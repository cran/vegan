...
\date{$ $Id: diversity-vegan.Rnw 508 2008-09-26 11:47:00Z jarioksa $ $
  processed with vegan 1.15-2
  in R version 2.9.0 RC (2009-04-10 r48321) on \today}
\usepackage{Sweave}
\begin{document}
...
Frequencies by Octave
                0        1        2         3        4         6
Observed 37.00000 15.00000 12.00000 14.000000 6.000000 2.0000000
Fitted   21.91936 23.55303 17.94385  9.692462 3.711953 0.1940389
\end{Soutput}
\end{Schunk}
...
\caption{Ranked abundance distribution models for a random plot
  (no. 29).  The best model is chosen by the \textsc{aic}, and
...
\begin{Soutput}
    Species     Chao  Chao.SE Jack.1 Jack1.SE   Jack.2     Boot
All     210 229.1842 9.647692 235.92  8.07485 244.0083 222.7069
     Boot.SE  n
All 4.562584 25
\end{Soutput}
\end{Schunk}
