...
\Address{$ $Id: diversity-vegan.Rnw 2544 2013-07-09 13:07:03Z jarioksa $ $
  processed with vegan 2.0-8
  in R version 2.15.2 (2012-10-26) on \today}
...
to the BCI data, but here our random plot (number 29):
\begin{Schunk}
\begin{Sinput}
...
No. of species: 86 
      ...
      mode      width         S0 
 0.7090315  1.7052549 23.8984091 

Frequencies by Octave
                0        1        2         3        4        5
Observed 18.50000 26.00000 18.50000 14.500000 6.000000 0.500000
Fitted   21.91936 23.55303 17.94385  9.692462 3.711953 1.007908
                 6
Observed 2.0000000
Fitted   0.1940389
\end{Soutput}
...
No. of species 86, total abundance 364

           par1      par2     par3     Deviance AIC     BIC    
Null                                   117.880  355.738 355.738
Preemption  0.052888                   124.438  364.295 366.750
Lognormal   0.68438   1.2574            36.783  278.640 283.549
Zipf        0.173    -0.93219           15.446  257.303 262.212
Mandelbrot  0.24126  -1.0276   0.52084  13.861  257.718 265.081
\end{Soutput}
\end{Schunk}
\begin{SCfigure}
\includegraphics{diversity-vegan-022}
\caption{Ranked abundance distribution models for a random plot
  (no. 29).  The best model has the lowest \textsc{aic}.}
\label{fig:rad}
\end{SCfigure}
...
1.6547 0.8870 0.5334 0.3744 0.2873 0.2245 0.1613 0.0810 
\end{Soutput}
\end{Schunk}
\begin{SCfigure}
...
All     204 218.4 7.702467 227.04 6.575591 231.4867 215.607 3.857472 25
\end{Soutput}
\end{Schunk}
