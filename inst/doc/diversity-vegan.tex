...
to the BCI data, but here our random plot (number 36):
\begin{Schunk}
\begin{Sinput}
> prestondistr(BCI[k, ])
\end{Sinput}
...
No. of species: 92 
      ...
      mode      width         S0 
 0.8352028  1.7913322 24.1844800 

Frequencies by Octave
                0        1        2        3        4        5
Observed 35.00000 19.00000 16.00000  7.00000 9.000000 5.000000
Fitted   21.69362 24.08235 19.57600 11.65218 5.078656 1.620871
                 6
Observed 1.0000000
Fitted   0.3787968
\end{Soutput}
...
No. of species 92, total abundance 430

           par1      par2     par3    Deviance AIC      BIC     
Null                                   85.9601 348.6007 348.6007
Preemption  0.049495                   70.0645 334.7051 337.2269
Lognormal   0.86697   1.1832           28.5832 295.2238 300.2674
Zipf        0.14615  -0.86285          37.0519 303.6925 308.7361
Mandelbrot  1.6203   -1.4888   5.7543   5.8926 274.5332 282.0986
\end{Soutput}
\end{Schunk}
\begin{SCfigure}
\includegraphics{diversity-vegan-022}
\caption{Ranked abundance distribution models for a random plot
  (no. 36).  The best model has the lowest \textsc{aic}.}
\label{fig:rad}
\end{SCfigure}
...
All     209 231.5333 11.59737 233.96 7.394701 244.655 220.9073 4.106949
     n
All 25
\end{Soutput}
\end{Schunk}
