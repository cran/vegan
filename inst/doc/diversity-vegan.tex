...
\date{$ $Id: diversity-vegan.Rnw 1036 2009-10-07 07:06:36Z jarioksa $ $
  processed with vegan 1.17-9
  in R version 2.13.0 beta (2011-03-30 r55204) on \today}
\usepackage{Sweave}
\begin{document}
...
to the BCI data, but here our random plot (number 6):
\begin{Schunk}
\begin{Sinput}
> prestondistr(BCI[k, ])
\end{Sinput}
...
No. of species: 85 
      ...
      mode      width         S0 
 0.7906605  1.8820182 21.7263218 

Frequencies by Octave
                0        1        2        3        4        5
Observed 17.00000 25.50000 17.00000 12.00000 7.000000 5.500000
Fitted   19.89119 21.59233 17.67361 10.90782 5.076187 1.781247
                 6
Observed 1.0000000
Fitted   0.4713004
\end{Soutput}
...
No. of species 85, total abundance 412

           par1      par2     par3    Deviance AIC      BIC     
Null                                   72.1627 316.7549 316.7549
Preemption  0.053815                   54.7709 301.3631 303.8058
Lognormal   0.90186   1.1859           19.5788 268.1711 273.0564
Zipf        0.15132  -0.86878          32.4630 281.0552 285.9405
Mandelbrot  2.2016   -1.5684   6.3479   5.5973 256.1895 263.5174
\end{Soutput}
\end{Schunk}
\begin{SCfigure}
\includegraphics{diversity-vegan-022}
\caption{Ranked abundance distribution models for a random plot
  (no. 6).  The best model has the lowest \textsc{aic}.}
\label{fig:rad}
\end{SCfigure}
...
All     210 234.3 12.29414 235.92 6.922658 247.535 222.2863 3.843217 25
\end{Soutput}
\end{Schunk}
