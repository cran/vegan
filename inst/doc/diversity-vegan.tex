...
to the BCI data, but here our random plot (number 16):
\begin{Schunk}
\begin{Sinput}
> prestondistr(BCI[k, ])
\end{Sinput}
...
Frequencies by Octave
               0        1        2        3        4       5
Observed 32.0000 22.00000 13.00000 14.00000 5.000000 7.00000
Fitted   20.5744 24.73812 21.00633 12.59731 5.335182 1.59575
\end{Soutput}
\end{Schunk}
...
\caption{Ranked abundance distribution models for a random plot
  (no. 16).  The best model is chosen by the \textsc{aic}, and
...
All     209 229.25 10.18731 234.92 6.922658 243.89 221.4221 4.041603 25
\end{Soutput}
\end{Schunk}
