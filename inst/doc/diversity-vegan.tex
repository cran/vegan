...
\date{$ $Id: diversity-vegan.Rnw 1036 2009-10-07 07:06:36Z jarioksa $ $
  processed with vegan 1.17-8
  in R version 2.12.2 (2011-02-25) on \today}
\usepackage{Sweave}
\begin{document}
...
to the BCI data, but here our random plot (number 31):
\begin{Schunk}
\begin{Sinput}
> prestondistr(BCI[k, ])
\end{Sinput}
...
Frequencies by Octave
                0        1        2        3        4        5
Observed 26.00000 13.00000 12.00000 13.00000 6.000000 6.000000
Fitted   15.63531 19.11148 17.23134 11.45989 5.621847 2.034297
                 6
Observed 1.0000000
Fitted   0.5429834
\end{Soutput}
...
\caption{Ranked abundance distribution models for a random plot
  (no. 31).  The best model has the lowest \textsc{aic}.}
\label{fig:rad}
\end{SCfigure}
...
All     206 225.5312 10.21804   230 8.428523 238.8933 217.4745 4.672663
     n
All 25
\end{Soutput}
\end{Schunk}
