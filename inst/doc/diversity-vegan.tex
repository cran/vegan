...
to the BCI data, but here our random plot (number 1):
\begin{Schunk}
\begin{Sinput}
> prestondistr(BCI[k, ])
\end{Sinput}
...
No. of species: 93 
     ...
     mode     width        S0 
 1.196852  1.671488 24.509779 

Frequencies by Octave
                0        1        2        3         4        5
Observed 15.50000 24.50000 21.00000 14.50000 11.500000 6.000000
Fitted   18.96729 24.34039 21.83759 13.69734  6.006518 1.841467
\end{Soutput}
\end{Schunk}
...
\caption{Ranked abundance distribution models for a random plot
  (no. 1).  The best model has the lowest \textsc{aic}.}
\label{fig:rad}
\end{SCfigure}
...
All     212 240.0333 13.74118 239.84  7.05453 253.295 225.038 4.043765
     n
All 25
\end{Soutput}
\end{Schunk}
