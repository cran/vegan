...
\author{Jari Oksanen}
\date{$ $Id: diversity-vegan.Rnw 271 2008-03-20 08:41:29Z jarioksa $ $
  processed with vegan 1.11-2
...
to the BCI data, but here our random plot (number 25):
\begin{Schunk}
\begin{Sinput}
> prestondistr(BCI[k, ])
\end{Sinput}
...
No. of species: 105 
     ...
     mode     width        S0 
 0.957454  1.622660 29.131500 

Frequencies by Octave
                0        1        2        3        4        5
Observed 40.00000 20.00000 19.00000 13.00000 8.000000 4.000000
Fitted   24.47713 29.12149 23.69874 13.19155 5.022556 1.308014
                 6
Observed 1.0000000
Fitted   0.2330016
\end{Soutput}
...
\caption{Ranked abundance distribution models for a random plot
  (no. 25).  The best model is chosen by the \textsc{aic}, and
...
\begin{Soutput}
    Species     Chao  Chao.SE Jack.1 Jack1.SE   Jack.2     Boot
All     212 231.8824 10.19570 236.96 8.136437 245.8917 224.2438
     Boot.SE  n
All 4.654368 25
\end{Soutput}
\end{Schunk}
