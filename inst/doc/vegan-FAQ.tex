...
cca(formula = varespec[i, ] ~ Al + K, data = varechem) 
              ...
              Inertia Rank
Total          2.0832     
Constrained    0.1952    2
Unconstrained  1.8880   21
Inertia is mean squared contingency coefficient 
...
Eigenvalues for unconstrained axes:
    CA1     CA2     CA3     CA4     CA5     CA6     CA7     CA8 
0.51985 0.32392 0.22645 0.18602 0.13657 0.11026 0.09938 0.07422 
(Showed only 8 of all 21 unconstrained eigenvalues)
\end{Soutput}
\end{Schunk}
...
observed 2.6369e-14 because site
...
\section{\protect{$t$}-values in constrained ordination}
...
pH        1 0.1458 1.7453    200  0.055 .
Ca        1 0.1827 2.1864    200  0.030 *
Residual 21 1.7547                       
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
\end{Soutput}
