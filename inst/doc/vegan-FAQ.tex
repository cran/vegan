...
cca(formula = varespec[i, ] ~ Al + K, data = varechem) 
              ...
              Inertia Rank
Total          2.0832     
Constrained    0.1742    2
Unconstrained  1.9090   21
Inertia is mean squared contingency coefficient 
...
Eigenvalues for unconstrained axes:
    CA1     CA2     CA3     CA4     CA5     CA6     CA7     CA8 
0.51940 0.31250 0.21739 0.18294 0.15801 0.11650 0.10338 0.07194 
(Showed only 8 of all 21 unconstrained eigenvalues)
\end{Soutput}
\end{Schunk}
...
observed 1.7223e-14 because site
...
pH        1 0.1458 1.7453    200   0.06 .
Ca        1 0.1827 2.1864    200   0.02 *
Residual 21 1.7547                       
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
\end{Soutput}
