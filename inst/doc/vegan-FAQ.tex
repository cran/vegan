...
cca(formula = varespec[i, ] ~ Al + K, data = varechem) 
              ...
              Inertia Rank
Total          2.0832     
Constrained    0.1896    2
Unconstrained  1.8936   21
Inertia is mean squared contingency coefficient 
...
Eigenvalues for unconstrained axes:
    CA1     CA2     CA3     CA4     CA5     CA6     CA7     CA8 
0.50181 0.29594 0.22996 0.18621 0.16256 0.11159 0.09761 0.07467 
(Showed only 8 of all 21 unconstrained eigenvalues)
\end{Soutput}
\end{Schunk}
...
observed 1.9475e-14 because site
...
pH        1 0.1458 1.7453    200  0.070 .
Ca        1 0.1827 2.1864    200  0.015 *
Residual 21 1.7547                       
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 
\end{Soutput}
